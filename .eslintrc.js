module.exports = {
    ...
    rules: {
        ...
        'no-unused-vars': ['error', { args: 'none' }], // warning about unused variables global/local, ignore arguments/params
    ...
    overrides: [
        {
            ...
            rules: {
                ...
                '@typescript-eslint/no-unused-vars': ['error', { args: 'none' }], // warning about unused variables global/local, ignore arguments/params
