...
function EditAvatar({ color, image, userId, uploadAvatar, uploadThumbnail, statusUploadAvatar, resetUploadAvatarStatus, posts, language }: EditAvatarProps)
{
    ...
    useEffect(() =>
    {
        if (statusUploadAvatar == STATUS.FAILED || statusUploadAvatar == STATUS.SUCCESS)
        {
            ...
            {
                ShowToast('error', language.ERROR_UPLOAD, language.UPLOAD_IMAGE_FAILED_TRY_LATER);
            }
