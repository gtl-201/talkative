    ...
    const changeCoordinates = (region) => {
      ...
      if (
        isPointWithinRadius(
          { latitude, longitude },
          {
            latitude: refCenterCircle.current.latitude,
            longitude: refCenterCircle.current.longitude,
          },
          700
        ) !== allowed
      ) {
    ...
    return (
      ...
      >
        <View style={styles.container}>
          ...
          >
            <Circle
              fillColor={"rgba(36, 168, 175, 0.1)"}
              strokeWidth={0}
              center={refCenterCircle.current}
              radius={700}
          ...
          {marker ? (
            <MarkerPost style={{ bottom: "50%" }} color={color} item={marker} />
          ) : null}
            ...
            style={[
              styles.btnShare,
              {
                backgroundColor: allowed
                  ? color.BG_BTN_PICK_ACTIVE
                  : color.BG_BTN_PICK_INACTIVE,
              },
            ]}
