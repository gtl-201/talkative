...
const styleScaled = (Color: any) => {
  return ScaledSheet.create({
    ...
    viewDrag: {
      width: "100%",
      height: "5@vs",
      backgroundColor: Color.LIST_POST_BG_DRAG,
      borderRadius: "10@ms",
    },
    viewStar: {
      position: "absolute",
    ...
    containerItem: {
      ...
      borderRadius: "15@ms",
      backgroundColor: Color.LIST_POST_BG_CONTAINER_ITEM,
      paddingHorizontal: "5%",
      alignItems: "center",
      paddingBottom: "15@vs",
      ...SHADOW_3,
    ...
    iconType: {
      color: Color.LIST_POST_IC_TYPE,
      fontSize: "14@ms0.3",
    },
    iconArrowClose: {
      color: Color.LIST_POST_IC_ARROW,
      fontSize: "20@ms0.3",
    },
    iconCount: {
      color: Color.LIST_POST_IC_COUNT,
      fontSize: "14@ms0.3",
    },
    txtType: {
      color: Color.LIST_POST_TXT_DURATION,
      marginLeft: "6@s",
      fontSize: "13@ms0.3",
    },
    viewHeaderItem: {
    ...
    txtNickname: {
      ...
      fontWeight: "bold",
      marginBottom: "2@vs",
      color: Color.LIST_POST_TXT_NICK,
    },
    txtCreateTs: {
      fontSize: "15@ms0.3",
      color: Color.LIST_POST_TXT_CREATES,
    },
    hitSlop: {
      top: "15@vs",
      left: "15@s",
    ...
    viewCloseBtn: {
      ...
      justifyContent: "center",
      alignItems: "center",
      backgroundColor: Color.LIST_POST_BG_CLOSE_BTN,
      ...SHADOW_2,
    },
    txtCountInfor: {
      fontSize: "14@ms0.3",
      width: "100%",
      textAlign: "right",
      color: Color.LIST_POST_TXT_COUNT_INFOR,
    },
    txtLabel: {
      fontSize: "19@ms0.3",
      fontWeight: "bold",
      color: Color.LIST_POST_TXT_LABEL,
    },
    txtTag: {
      fontSize: "16@ms0.3",
      color: Color.LIST_POST_TXT_TAG,
      marginBottom: "5@vs",
    },
    txtContent: {
      fontSize: "16@ms0.3",
      color: Color.LIST_POST_TXT_CONTENT,
      lineHeight: "22@vs",
    },
    image: {
      borderRadius: "5@ms",
