...
const ListType: FC<any> = (props) => {
  ...
  const renderItem = ({ item }) => {
    ...
    return (
      <TouchableOpacity
        onPress={() => updateTypeSelected(type)}
        style={[
          styles.touchItem,
          {
            backgroundColor: refTypesSelected.current.includes(type)
              ? color
              : props.color.LIST_TYPE_BG_ITEM,
          },
        ]}
      >
        <Icon
          ...
          name={icon}
          color={
            refTypesSelected.current.includes(type)
              ? props.color.LIST_TYPE_IC_ITEM
              : color
          }
        ...
        <Text
          style={[
            styles.textItem,
            {
              color: refTypesSelected.current.includes(type)
                ? props.color.LIST_TYPE_TXT_ITEM
                : color,
            },
          ]}
        >
