...
const Item: FC<ItemProps> = ({
  ...
  return (
    <Pressable onPress={viewPostMap} style={styles.pressableItem}>
      <View style={styles.containerItem}>
        ...
        <View style={styles.viewHeader}>
          ...
          <View style={styles.viewInfor}>
            ...
            <Text style={styles.txtCreateTs}>
              {moment(item.create_ts).format("HH:mm  DD/MM/yyyy")}
            </Text>
          </View>
        </View>
            ...
            <FastImage
              style={[
                styles.image,
                {
                  height:
                    item.image_height /
                    (item.image_width / (SIZES.WIDTH_WINDOW * 0.9 * 0.84)),
                },
              ]}
              source={{
                uri: item.image,
        ...
        <LinearGradient
          ...
          colors={["#00000000", color.LISTPOST_LG]}
          locations={[0, 0.9]}
          pointerEvents={"none"}
