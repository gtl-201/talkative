...
{
    const { color, navigation, userInfor, language } = props;
        ...
        <View>
            ...
            >
                ...
                <View style={styles.containerInfor}>
                    ...
                    {userInfor.dob ? <Text style={styles.textDob}>{moment(userInfor.dob).format('DD/MM/YYYY')}</Text> : null}
...
//                     />
//                     {'  ' + ((caller.length ?? 0) + (callee.length ?? 0)) + ' '}
//                     {language.Call}
//                 </Text>
//                 <Text
//                     style={styles.textTag}
