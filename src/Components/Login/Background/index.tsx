...
const Background: FC<any> = (props) =>
{
    ...
    {
        const translateX = interpolate(translationX.value, [0, SIZES.WIDTH_WINDOW * (sizeStep - 1)], [-SIZES.WIDTH_WINDOW * 0.1, -SIZES.WIDTH_WINDOW * 1.15], Extrapolate.CLAMP);
