        ...
        return (
            <View style={styles.viewDisplayName}>
                ...
                <Text
                    ...
                    ellipsizeMode={'tail'}
                >
                    {reverse ? firstName + ' ' + lastName : lastName + ' ' + firstName}
                </Text>
            </View>
        );
    }),
...
const RegisterInformation: FC<any> = forwardRef((props, ref) =>
{
    ...
    const displayName: any = useRef(null);
    ...
    useEffect(() =>
    {
        if (statusUploadAvatar == STATUS.FAILED || statusUploadAvatar == STATUS.SUCCESS)
        {
            ...
            {
                ShowToast('error', language.ERROR, language.UPLOAD_IMAGE_FAILED_TRY_LATER);
            }
    ...
    return (
        <View style={styles.container}>
            <Text
                ...
                ellipsizeMode={'tail'}
            >
                {`${language.WELCOME} ${userInfor.nickname}`}
            </Text>
            ...
            <View style={{ flexDirection: 'row' }}>
                ...
                <DisplayName
                    ...
                    language={language}
                    styles={styles}
                    setUserInfor={UserActionsDispatch.setUserInfor}
                />
            </View>
