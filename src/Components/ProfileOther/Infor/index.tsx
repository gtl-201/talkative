...
const Infor: FC<Props> = (props) =>
{
    ...
    const onAlertPress = useCallback(() => ShowToast('info', language.LET_ME_TELL_YOU, language.REPORT_NOT_AVAILABLE), []);
            ...
            >
                ...
                >
                    <Icon
                        ...
                        name={'account-alert'}
                        size={moderateScale(23, 0.3)}
                        color={color.INFOR_IC_REPORT}
                    />
                </TouchableOpacity>

                <View style={styles.containerInfor}>
                    <Text
                        style={styles.textNickname}
                        numberOfLines={2}
                        ellipsizeMode={'tail'}
                    >
                        {userInfor && userInfor.nickname ? userInfor.nickname : '...........'}
                        <Icon
                            type={'MaterialCommunityIcons'}
                    ...
                    <Text style={styles.textDescription}>{userInfor && userInfor.description ? userInfor.description : '...'}</Text>
                </View>
            </TouchableOpacity>
