...
const Statistics: FC<any> = (props) => {
  ...
  const renderCountView = useCallback(
    ({ item }) => {
      return (
        <View style={styles.viewCount}>
          <Text
            ...
            style={[
              ...
              {
                color:
                  COLOR_TYPE[item[0].substring(2).toUpperCase()] ||
                  color.TXT_COUNT,
              },
            ]}
          >
            {item[0] === "c_country" ? item[1].length : item[1]}
          </Text>
          ...
          <View
            style={[
              ...
              {
                backgroundColor: COLOR_TYPE[item[0].substring(2).toUpperCase()],
              },
            ]}
          />
          {ICON_TYPE[item[0].substring(2).toUpperCase()] ? (
            <Icon
              type={"MaterialCommunityIcons"}
              name={ICON_TYPE[item[0].substring(2).toUpperCase()]}
  ...
  return (
    ...
    >
      ...
      <View style={styles.viewPost}>
        ...
        <View style={styles.viewDescription}>
          <Text style={styles.txtDescriptionShare}>
            {language.POST_HAVE_BEEN}
          </Text>
          <Icon
            type={"FontAwesome"}
            name={"share-alt"}
