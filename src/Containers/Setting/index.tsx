...
{
    const { setBackgroundScreenDrawer, updateSetting, color, language } = props;
    ...
    return (
        ...
        >
            ...
            <View style={styles.viewOption}>
                ...
                <Switch
                    trackColor={{
                        true: color.BG_SWITCH_ACTIVE,
                        false: color.BG_SWITCH_INACTIVE,
                    }}
            ...
            <View
                ...
                hitSlop={{ bottom: verticalScale(100) }}
            >
