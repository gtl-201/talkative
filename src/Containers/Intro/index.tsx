...
const Intro: FC<any> = ({
  ...
  const pressRouter = (next: boolean) => {
    ...
    } else if (currentIndex > 0) slideList.current.scrollTo(currentIndex - 1);
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.viewRouter}>
        ...
        <TouchableOpacity
          style={[styles.routerTouch, { backgroundColor: color.BG_BTN_NEXT }]}
...
function mapDispatchToProps(dispatch: any) {
  return {
    updateSetting: bindActionCreators(
      ControlAppActions.updateSetting,
      dispatch
    ),
  };
}
