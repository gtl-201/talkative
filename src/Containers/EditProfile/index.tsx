...
const EditProfile: FC<any> = ({ navigation, color, userInfor, UserActionsDispatch, setBackgroundScreenDrawer, statusUploadAvatar, language }: EditProfileProps) =>
{
    ...
    useEffect(() =>
    {
        ...
        UserServices.getUserInfor('get').then((data) => setUser(data));
        UserServices.getUserMeetingCaller('get');
        UserServices.getUserMeetingCallee('get');
    }, []);

    useEffect(() => console.log(userInfor), [userInfor]);
    ...
    return (
        ...
        >
            ...
            <ScrollView style={styles.scrollView}>
                <EditAvatar
                    statusUploadAvatar={statusUploadAvatar}
                    language={language}
                    resetUploadAvatarStatus={UserActionsDispatch.resetUploadAvatarStatus}
                    posts={userInfor.posts}
                    uploadAvatar={UserActionsDispatch.uploadAvatar}
                    uploadThumbnail={UserActionsDispatch.uploadThumbnail}
