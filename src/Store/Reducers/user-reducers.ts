...
const actionHander = {
  ...
  [USER.RESET_UPLOAD_AVATAR_STATUS]: (state = initialState, _action: any) => {
    return {
      ...state,
      statusUploadAvatar: STATUS.WAIT,
    };
  },
  [USER.UPLOAD_AVATAR]: (state = initialState, _action: any) => {
    return {
      ...state,
  ...
  [USER.UPLOAD_AVATAR_FAILED]: (state = initialState, _action: any) => {
    return {
      ...state,
  ...
  [USER.UPLOAD_THUMBNAIL_FAILED]: (state = initialState, _action: any) => {
    return {
      ...state,
  ...
  [USER.SYNC_USERINFOR_FAILED]: (state = initialState, _action: any) => {
    return {
      ...state,
