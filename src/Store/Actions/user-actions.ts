...
export function uploadAvatar(path: string, name: string, needUpdateServer = true)
{
    return {
...
export function uploadThumbnail(path: string, name: string, posts: Array<Post> = [], needUpdateServer = true)
{
    return {
